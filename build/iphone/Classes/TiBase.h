...
// in simulator we redefine to format for hotel Developer console
...
{\
	NSString * exceptionName = [@"org.hotel." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hotel";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIhotelNativeItemNone = -1, 
	UIhotelNativeItemSpinner = -2,
	UIhotelNativeItemProgressBar = -3,
	
	UIhotelNativeItemSlider = -4,
	UIhotelNativeItemSwitch = -5,
	UIhotelNativeItemMultiButton = -6,
	UIhotelNativeItemSegmented = -7,
	
	UIhotelNativeItemTextView = -8,
	UIhotelNativeItemTextField = -9,
	UIhotelNativeItemSearchBar = -10,
	
	UIhotelNativeItemPicker = -11,
	UIhotelNativeItemDatePicker = -12,
	
	UIhotelNativeItemInfoLight = -13,
	UIhotelNativeItemInfoDark = -14,
	
	UIhotelNativeItemDisclosure = -15,
	
	UIhotelNativeItemContactAdd = -16
};
